import { Exam, QuestionType, ExamMetadata } from '../types';
...
export const EXAM_REGISTRY: ExamMetadata[] = [
  {
    ...
    shift: 'Shift 1',
    status: 'AVAILABLE',
    description: 'Full length mock test based on memory based questions.'
  },
  {
  ...
  {
    id: 'cuet-ug-2024-general',
    title: 'CUET UG 2024 (General Test)',
    type: 'CUET',
    year: 2024,
    date: '15 May',
    status: 'COMING_SOON',
    description: 'General test practice paper.'
  }
];
      ...
      sections: [
        {
          ...
          questions: [
            ...
            // ... (Rest of questions omitted for brevity as they are unchanged)
          ]
        },
        // ... (Rest of sections omitted for brevity as they are unchanged)
      ]
    }
  ]
};
